export const data = {
    ...
    applicability: 'Todas las tecnologías donde el sonido se puede reproducir automáticamente.',
    ...
    example: [
        {
            title: 'Ejemplo 1',
            resume: 'Una página web contiene una presentación multimedia basada en el tiempo que incluye una pista de audio y un video animado que describe cómo reparar el motor de una cortadora de césped. La página contiene 2 botones que dicen "Pausar" y "Detener", que le dan al usuario control sobre cuándo y si se reproducen los medios basados ​​en el tiempo.'
        },
        {
            title: 'Ejemplo 2:',
            resume: 'Una página web contiene un cortometraje incrustado. La página contiene un botón que dice "Pausar la película", que permite al usuario pausar la película.'
        },
        {
            title: 'Ejemplo 3:',
            resume: 'Una página web contiene una presentación que incluye video y audio. La página contiene un botón que dice "Desactivar multimedia", que permite al usuario detener la reproducción de cualquier video y audio.'
        }
    ],
