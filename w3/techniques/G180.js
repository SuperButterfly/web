export const data = {
    ...
    example: [
        {
            title:'Ejemplo 1:',
            resume: `Una aerolínea tiene una aplicación de compra de boletos en línea. Por defecto, la aplicación tiene un límite de tiempo de 1 minuto para cada paso del proceso de compra. Al comienzo de la sesión, una página web incluye información que dice: "Esperamos que los usuarios tarden un minuto en completar cada paso del proceso de compra. ¿Le gustaría ajustar el límite de tiempo?" seguido de varios botones de opción "1 minuto, 2 minutos, 5 minutos, 10 minutos".`,
        },
        {
            title:'Ejemplo 2:',
            resume: `Una aplicación de correo electrónico basada en la web cierra automáticamente la sesión de los usuarios cuando no ha habido actividad durante 30 minutos. La aplicación incluye una preferencia que permite a los usuarios ajustar la cantidad de tiempo a cualquier valor.`,
        }
    ],
