export const data = {
  ...
  resume:
    'La técnica de AutoPlaypropiedad se utiliza para prevenir la reproducción automática de medios en el MediaElementobjeto. Esto se logra estableciendo AutoPlayen false, y proporcionando controles de interfaz de usuario pertinentes que permitan al usuario controlar los medios, como reproducir, pausar o detener. Esto garantiza una mejor experiencia de accesibilidad para los usuarios.',

  example: [
    {
      title:
        'Ejemplo 1: configurar la reproducción automática en falso y proporcionar los controles típicos de MediaElement en la interfaz de usuario',
      resume:
        'Este ejemplo tiene una definición de interfaz de usuario en XAML y una lógica de interacción en C#. La siguiente es la interfaz de usuario básica en XAML. Tenga en cuenta la configuración de reproducción automática = "falso".',
