  ...
  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Use el cambio de página de estilo estándar y tenga un botón o enlace en la página que cambie la hoja de estilo. La nueva hoja de estilo contiene una regla para aumentar la altura de la línea y una clase para aumentar el espacio entre párrafos'
    }
  ],
