...
const Breakpoints = ({ isBreakOn, closeBreak }) => {
  ...
  useEffect(() => {
    ...
    const booleanValues = savedData && savedData.split(',').map(value => value.toLowerCase() === 'true');
    if (savedData) {
  ...
  if (isBreakOn) {
    return (
      ...
      <div className="breakpoints-container01">
        ...
        <button className="breakpoints-button" onClick={() => closeBreak(false)}>
          x
        </button>
      </div>
      <div className="breakpoints-container02">
        <div className="breakpoints-container03">
          ...
          >
            {isChecked[0] &&
              <svg viewBox="0 0 1024 1024" className="breakpoints-ok-icon"
                style={isChecked[0] ? { backgrondColor: '#f0f0f0' } : { backgrondColor: 'transparent' }}
              >
      ...
      <div className="breakpoints-container05">
        <div className="breakpoints-container06">
          ...
          >
            {isChecked[1] &&
              <svg viewBox="0 0 1024 1024" className="breakpoints-ok-icon"
                style={isChecked[1] ? { backgrondColor: '#f0f0f0' } : { backgrondColor: 'transparent' }}
              >
                <path d="M397.434 917.696l-397.868-391.6 197.378-194.27 200.49 197.332 429.62-422.852 197.378 194.27-626.998 617.12zM107.912 526.096l289.524 284.962 518.656-510.482-89.036-87.632-429.62 422.852-200.49-197.334-89.034 87.634z"></path>
              </svg>
            }  
      ...
      <div className="breakpoints-container08">
        <div className="breakpoints-container09">
          ...
          >
            {isChecked[2] &&
              <svg viewBox="0 0 1024 1024" className="breakpoints-ok-icon"
                style={isChecked[2] ? { backgrondColor: '#f0f0f0' } : { backgrondColor: 'transparent' }}
              >
                <path d="M397.434 917.696l-397.868-391.6 197.378-194.27 200.49 197.332 429.62-422.852 197.378 194.27-626.998 617.12zM107.912 526.096l289.524 284.962 518.656-510.482-89.036-87.632-429.62 422.852-200.49-197.334-89.034 87.634z"></path>
              </svg>
            }  
      ...
      <div className="breakpoints-container11">
        <div className="breakpoints-container12">
          ...
          >
            {isChecked[3] &&
              <svg viewBox="0 0 1024 1024" className="breakpoints-ok-icon"
                style={isChecked[3] ? { backgrondColor: '#f0f0f0' } : { backgrondColor: 'transparent' }}
              >
                <path d="M397.434 917.696l-397.868-391.6 197.378-194.27 200.49 197.332 429.62-422.852 197.378 194.27-626.998 617.12zM107.912 526.096l289.524 284.962 518.656-510.482-89.036-87.632-429.62 422.852-200.49-197.334-89.034 87.634z"></path>
              </svg>
            }  
      ...
      <div className="breakpoints-container14">
        <div className="breakpoints-container15">
          ...
          >
            {isChecked[4] &&
              <svg viewBox="0 0 1024 1024" className="breakpoints-ok-icon"
                style={isChecked[4] ? { backgrondColor: '#f0f0f0' } : { backgrondColor: 'transparent' }}
              >
                <path d="M397.434 917.696l-397.868-391.6 197.378-194.27 200.49 197.332 429.62-422.852 197.378 194.27-626.998 617.12zM107.912 526.096l289.524 284.962 518.656-510.482-89.036-87.632-429.62 422.852-200.49-197.334-89.034 87.634z"></path>
              </svg>
            }  
      ...
      <div className="breakpoints-container17">
        <div className="breakpoints-container18">
          ...
          >
            {isChecked[5] &&
              <svg viewBox="0 0 1024 1024" className="breakpoints-ok-icon"
                style={isChecked[5] ? { backgrondColor: '#f0f0f0' } : { backgrondColor: 'transparent' }}
              >
                <path d="M397.434 917.696l-397.868-391.6 197.378-194.27 200.49 197.332 429.62-422.852 197.378 194.27-626.998 617.12zM107.912 526.096l289.524 284.962 518.656-510.482-89.036-87.632-429.62 422.852-200.49-197.334-89.034 87.634z"></path>
              </svg>
            } 
      ...
      <div className="breakpoints-container20">
        <span>Show breakpoints lines</span>
        <div className="breakpoints-container21">
          <div className="breakpoints-container22"></div>
        </div>
      </div>
