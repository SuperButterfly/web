export const data = {
  ...
  relation: ['1.2.6'],
  applicability:
    'Se aplica siempre que el reproductor SMIL 1.0 esté disponible',
  resume:
  ...
  example: [
    {
      title:
        'Ejemplo 1: muestra de interpretación de lenguaje de señas SMIL 1.0 para reproductor QuickTime',
    ...
    {
      title:
        'Ejemplo 2: Muestra de lenguaje de señas SMIL 1.0 para el reproductor RealMedia:',
      resume:
        'El ejemplo muestra un segmento <par> que contiene dos etiquetas <video>. El atributo system-captions indica que el video en lenguaje de señas debe mostrarse cuando la configuración del reproductor del usuario para los subtítulos indica la preferencia de los subtítulos que se mostrarán. La sección <layout> define las regiones utilizadas para el video principal y el video de interpretación del lenguaje de señas.',
