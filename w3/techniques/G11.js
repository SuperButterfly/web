export const data = {
    ...
    resume: ' El objetivo de esta técnica es minimizar la distracción causada por el contenido parpadeante y permitir que los usuarios vuelvan a concentrarse en el otro contenido de la página.',
    
    example: [
        {
            title:'Ejemplo 1:',
            resume: `Se utiliza una imagen animada para resaltar los artículos en oferta. Dentro de una lista de artículos para comprar, se usa una imagen de una etiqueta roja seguida de la frase "En oferta" para indicar los artículos que se ofrecen a un precio reducido. La imagen de la etiqueta roja parpadea al cargar la página y se detiene en cinco segundos.`,
        }
    ],
