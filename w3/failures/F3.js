export const data = {
    ...
    resume: 'La propiedad background-image de CSS proporciona una forma de incluir imágenes en el documento con CSS sin referencia en el código HTML. Sin embargo, no se pueden asociar alternativas de texto con estas imágenes, por lo que no se recomienda usar esta propiedad para transmitir información importante.',
    ...
    example: [
        {
            title: 'Ejemplo 1',
            resume: 'parte del contenido está contenido en una imagen que se presenta solo con CSS. En este ejemplo, la imagen TopRate.png es una imagen de 180 por 200 píxeles que contiene el texto "19,3 % APR variable típica',
        ...
        {
            title: `Ejemplo 2`,
            resume: 'Un distribuidor de libros utiliza imágenes de fondo para proporcionar iconos en una lista de títulos de libros para indicar si son nuevos, limitados, en stock o agotados. El CSS contiene:',
        ...
        {
            title: 'Ejemplo 3',
            resume: 'Usando el código del ejemplo 1, la misma imagen de fondo se declara en el atributo de estilo HTML:',
    ...
    tests:[
         {
            ...
            results: 'Si el paso n.º 2 y el paso n.º 3 son falsos, entonces se aplica esta condición de falla y el contenido no cumple con este Criterio de Conformidad.'
        }
    ]
}