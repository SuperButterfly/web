...
example: [
    {
        title:'Ejemplo 1:',
        resume: `Un botón de búsqueda utiliza una imagen de una lupa. La alternativa de texto es "buscar" y no "lupa"`
    },
    {
        title:'Ejemplo 2:',
        resume: `Una imagen muestra cómo se hace un nudo, incluidas las flechas que muestran cómo van las cuerdas para hacer el nudo. La alternativa de texto describe cómo atar el nudo, no cómo se ve la imagen.`
    },
    {
        title:'Ejemplo 3:',
        resume: 'Una imagen muestra cómo se ve un juguete de frente. La alternativa de texto describe una vista frontal del juguete.'
    },
    {
        title:'Ejemplo 4:',
        resume:'Una animación muestra cómo cambiar un neumático. Una breve alternativa de texto describe de qué se trata la animación. Una alternativa de texto largo describe cómo cambiar un neumático.'
    },
    {
        title:'Ejemplo 5:',
        resume: 'Un logotipo de la compañía TechTron aparece al lado de cada producto en una lista que está hecha por eso y tiene una alternativa de texto breve que dice "TechTron".'
    },
    {
        title:'Ejemplo 6:',
    ...
    {
        title:'Ejemplo 7:',
        resume:'Un encabezado contiene una imagen de las palabras "La historia de la guerra" en texto estilizado. El texto alternativo de la imagen es "La historia de la guerra".'
    },
    {
        title:'Ejemplo 8:',
        resume: 'Una imagen de una serie de libros en un estante contiene áreas interactivas que proporcionan los medios de navegación a una página web sobre el libro en particular. La alternativa de texto "Los libros disponibles para comprar en esta sección. Seleccione un libro para obtener más detalles sobre ese libro". describe la imagen y la naturaleza interactiva.'
    }
],
...
tests:[
    {
        ...
        results: 'La verificación #3 es verdadera. Si el contenido que no es de texto contiene palabras que son importantes para comprender el contenido, la verificación #4 también es verdadera'
    }
]
}