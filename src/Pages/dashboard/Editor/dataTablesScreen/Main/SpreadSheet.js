...
class Spreadsheet {
  constructor(
    ...
    this.selectedColumn = awareness.selectedColumn
    this.selectedRow = awareness.selectedRow
    this.selectedCell = awareness.selectedCell
    this.data = data
  ...
  * genColumnTitle(lastColumnTitle) {
  ...
  set selectedColumn(column) {
    this.selectedColumn = { columnTitle: column.columnTitle, id: column.id }
