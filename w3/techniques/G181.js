export const data = {
  ...
  applicability:
    'Páginas que requieren autenticación de usuario donde el tiempo disponible para enviar datos es limitado.',
