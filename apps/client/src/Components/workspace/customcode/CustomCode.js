    ...
    <div className="custom-code-container">
      <div className="custom-code-google-container">
        ...
        <div className="custom-code-paragraph-container">
          <span className="custom-code-text1">
            You can find your Google Tag Manager ID
          </span>
      ...
      <div className="custom-code-custom-container">
        ...
        <div className="custom-code-section">
          <span className="custom-code-custom-title">
            Use this section if you want to add a 3rd party tool. You will not
            be able to interact with the 3rd party code while editing your
            project in the playground, this will only work on your published
            websites.
          </span>
          <div className="custom-code-paragraph-container2">
            <span className="custom-code-text22">
              For custom fonts, use the <a href="#">dedicated section.</a>
              You can add here: <a href="#">link,</a> <a href="#">meta,</a>{' '}
              <a href="#">style,</a> and <a href="#">script.</a>
              Read more about what kind of html code is valid in the{' '}
              <a href="#">head</a> and <a href="#">body</a> tags documentation.
              If the embeddable code has opening and/or closing tags, make sure
              to add them too.
            </span>
          </div>
        </div>
        <br />
        <span className="custom-code-text22">
          WARNING: Invalid code added here might break your website.
        </span>
      </div>
      ...
      <button className="custom-code-save-button button">Save Changes</button>
    </div>
  )
}
