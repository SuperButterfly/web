...
export function SecondListInputsMedia({
  ...
  const [showSecondListMedia, setShowSecondListMedia] = useState({
    second: false,
    third: false,
    fourth: false,
    fifth: false,
  ...
  const showPropertiesList = () => {
    setShowSecondListMedia({
      second: !showSecondListMedia.second,
      third: false,
      fourth: false,
      fifth: false
    })
  ...
  const showValueMediaList = () => {
    setShowSecondListMedia({
      second: false,
      third: !showSecondListMedia.third,
      fourth: false,
      fifth: false
    })
  }
  const showFourthListMedia = (index) => {
    setShowSecondListMedia({
      second: false,
      third: false,
      fourth: !showSecondListMedia.fourth,
      fifth: false,
      indexMenu: index
    })
  }
  const showFifthListMedia = (key, index) => {
    ...
    setShowSecondListMedia({
      second: false,
      third: false,
      fifth: !showSecondListMedia.fifth,
      fourth: false,
      indexMenu: index
    })
  }
