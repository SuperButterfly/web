...
const SearchBar = ({ handleSearch, placeholder }) => {
  ...
  return (
    ...
    <div className={styles.searchItems}>
      ...
      />
      <button onClick={executeSearch} className={styles.searchBtn}>
            <svg width="25px" height="25px" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.searchIcon}>
