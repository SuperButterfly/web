export const data = {
    ...
    resume: 'El objetivo de esta técnica es especificar un tamaño de fuente con nombre que exprese el tamaño de fuente relativo deseado. Estos valores proporcionan sugerencias para que el agente de usuario pueda elegir un tamaño de fuente relativo al tamaño de fuente heredado.',
