  ...
  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Un periódico en línea colocó una barra de navegación visualmente en la esquina superior izquierda de la página, directamente debajo de su logotipo inicial. En el código fuente, los elementos de navegación aparecen después de los elementos que codifican el logotipo.'
    }
  ],
