export const data = {
    ...
    example: [
        {
            title:'Ejemplo 1:',
            resume: `Una página contiene un banner parpadeante destinado a llamar la atención del usuario. El banner es una imagen gif animada que se repite indefinidamente. El usuario presiona la tecla "escape", lo que hace que el agente de usuario detenga la animación de todas las imágenes gif animadas en la página.`,
        }
    ],
