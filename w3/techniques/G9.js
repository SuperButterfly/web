export const data = {
  ...
  applicability:
    'Se aplica a todas las tecnologías que presentan información audiovisual.',
  ...
  example: [
    {
      title: 'Ejemplo 1',
      resume:
        'Un estudio de televisión utiliza un servicio de subtítulos en tiempo real para crear subtítulos para sus noticias de la noche en línea.'
    },
    {
      title: 'Ejemplo 2:',
      resume:
        'Un usuario mira un seminario en línea en su dispositivo móvil, incluidos los subtítulos proporcionados mediante el uso de Communication Access Real-time Translation (CART). Los subtítulos proporcionados también benefician a los participantes en persona que necesitan subtítulos y pueden ver la información en su propio dispositivo.'
    }
  ],
