    ...
    tests:[
         {
            procedure :[   
                {
                    title: 'Para todas las imágenes del contenido que transmitan información a través de diferencias de color:',
                    data: {
                        order: 1,
            ...
            results: 'Si el paso n.° 1 es verdadero, entonces se aplica esta condición de falla y el contenido falla el Criterio de Conformidad'
        }
    ]
}