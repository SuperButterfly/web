...
export function FirstListInputsMedia({
propertyKeys, 
objProperties, 
propertyElements,
inputValue
  ...
  const [showFirstListMedia, setShowFirstListMedia] = useState({second: false, third: false, fourth: false, fifth: false, indexMenu: 0})
 
  const [inputProperty, setInputProperty] = useState('')
  //const inputProperty = useRef(null)
  const [firstPropertyMediaList, setFirstPropertyMediaList] = useState({})
  
  useEffect(()=>{
    if(propertyElements){
        const mediaList = propertyElements["mq991"]
        //console.log("mediaList", mediaList)
        setFirstPropertyMediaList(mediaList)
    }
  },[propertyElements])
  
 
  const showPropertiesList = ()=>{
       setShowFirstListMedia({second: !showFirstListMedia.second, third: false, fourth: false, fifth: false})
  }
  const showValueMediaList = ()=>{
       setShowFirstListMedia({second: false, third: !showFirstListMedia.third, fourth: false, fifth: false})
  }
  const showFourthListMedia = (index)=>{
        setShowFirstListMedia({second: false, third: false, fourth: !showFirstListMedia.fourth ,fifth: false, indexMenu: index})
  }
  const showFifthListMedia = (key, index)=>{
        setInputProperty(key); 
        //console.log("showFirstListMedia",showFirstListMedia)
        setShowFirstListMedia({second: false, third: false, fifth: !showFirstListMedia.fifth, fourth: false, indexMenu: index})
  }
  const handleAddProperty = (index)=>{
       ...
       if(indexesList){
          ...
          setFirstPropertyMediaList(prev=>({...prev, [indexesList]: ""}))
          setShowFirstListMedia({second: false, third: !showFirstListMedia.third, fourth: false, fifth: false})
       }
  }
...
const handleAddProperties = (index, item, listObject)=>{
   ...
   if(listObject.key != [indexesList]){
     const propertiesToFilter = Object.entries(firstPropertyMediaList)
     ...
     setFirstPropertyMediaList(newObjProperty)
     
     dispatch(updateClassProperties(projectSelected.id, {
        nameClass: inputValue,
        properties: {
          ...propertyElements,
          mq991: newObjProperty || {},
        }
      }));

     setShowFirstListMedia((prev)=>({...prev, fourth: !showFirstListMedia.fourth}))
     //console.log("itemList", newObjProperty)
    }
    else{
         setShowFirstListMedia((prev)=>({...prev, fourth: false, fifth: !showFirstListMedia.fifth}))
     }
    }
  }
  ...
  const handleAddValue = (itemList)=>{
     if(itemList && inputProperty){
       const newPropertyAddList = { ...firstPropertyMediaList, [inputProperty]: itemList }
       setFirstPropertyMediaList(newPropertyAddList)
     //hace el dispatch cuando agrega el value a la propiedad del objeto
       const newProperties = {
              ...propertyElements,
              mq991: newPropertyAddList
         }
  ...
  const handleDeleteProperties = (newObject)=>{
     setFirstPropertyMediaList(newObject)
     ...
     setShowFirstListMedia((prev)=>({...prev, fourth: false, fifth: false}))
  }
                        ...
                        <div className="jsx-108338622">
                          <div className="pt-input-flexible">
                            <div className="input-addon-wrapper">
                              ...
                              ></input>
                              {showFirstListMedia.second && <div className="collapsable-container-second">
                        ...
                        <div className="jsx-108338622">
                          <div className="pt-input-flexible">
                            <div className="input-addon-wrapper">
                              ...
                              ></input>
                              {showFirstListMedia.third && <div className="collapsable-container-third">
