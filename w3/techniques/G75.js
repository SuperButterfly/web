  ...
  example: [
    {
      title: 'Ejemplo1:',
      resume:
        'Una página web proporciona cotizaciones de acciones y actualizaciones automáticas de vez en cuando. La página proporciona un breve formulario con un campo "Frecuencia de actualización de datos (minutos):" para que los usuarios puedan ajustar la frecuencia de la actualización.'
    }
  ],
