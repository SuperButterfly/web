export const data = {
  ...
  resume:
    'Describe una condición de falla para todas las técnicas que involucran alternativas de texto. Si el texto en la "alternativa de texto" no se puede usar en lugar del contenido que no es de texto sin perder información o función, falla porque, de hecho, no es una alternativa al contenido que no es de texto.',
  ...
  example: [
    {
      ...
      resume: {
        ...
        examples: [
          'texto de marcador de posición como " " o "espaciador" o "imagen" o "imagen", etc. que se colocan en la ubicación de "texto alternativo" en imágenes o imágenes',
