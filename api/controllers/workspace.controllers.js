...
const getUserWorkspaces = async (req, res, next) => {
  try {
    ...
    const userFound = await User.findOne({
      ...
      order:[
        [{model:Workspace,as:"workspace"},{model:Template,as:"projects"},{model:Component, as:"pages"},'name','ASC'],
        [{model:Workspace,as:"workspace"},{model:Template,as:"projects"},{model:Component, as:"components"},'name','ASC']
      ]
    });
