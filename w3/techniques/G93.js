export const data = {
  ...
  applicability:
    'Cualquier tecnología multimedia sincronizada, incluso las que no admiten subtítulos.',
  resume:
  ...
  example: [
    {
      title: 'Ejemplo 1:"',
      resume:
        'Para garantizar que todos puedan ver sus películas en línea, incluso si los usuarios no saben cómo activar los subtítulos en su reproductor multimedia, una asociación de bibliotecas coloca los subtítulos directamente en el video.'
    },
    {
      title: 'Ejemplo2:',
      resume:
        'Una organización de noticias proporciona subtítulos abiertos en todo su material.'
    }
  ],
  relTech: ['G87'],
  tests: [
