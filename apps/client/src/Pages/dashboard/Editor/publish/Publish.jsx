...
import './publish.css'
import InstanceConfig from './components/instance-config/InstanceConfig'
...
const Publish = ({ isPublishOn, closePublish }) => {
  ...
  const [showScw, setShowScw] = useState(false)

  const server = {
    type: 'Cost-optimized PRO2',
    cost: 0.034,
    image: 'Ubuntu JellyFish 22'
  }
      ...
      <>
        ...
        <div className="publish-container">
          ...
          <div className="publish-container01">
            ...
            <button className="publish-button1" onClick={() => setShowScw(true)}>
              <svg
                version="1.0"
...
322 -1 345 -20 375 -37 61 -114 87 -175 59z"
          ...
          </div>
          {
            ...
            :
            <>
              <InstanceConfig zone='Paris 1' serverConfig={server} blockStorageConfig={blockStorage} publicIPConfig={publicIP}/>
            </>
          }
