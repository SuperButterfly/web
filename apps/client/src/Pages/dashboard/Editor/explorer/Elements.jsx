/* global localStorage */
import SearchElemensPanel from "./SearchElemensPanel/SearchElemensPanel"
import './elements.css'
...
const Elements = () => {
  ...
  const handleInputChange =ev=>{
    setInput({...input,value:ev.target.value})
    setIsExpand(ev.target.value.length>0)
  }
  ...
  return (
    <div className="elements-container">
      <div className="elements-container-01">
        <SearchBar handleSearchClick={console.log(`Searching element: ${input.value}`)} 
      ...
      <SearchElemensPanel value={input.value} isExpand={isExpand}/>
    </div>
  )
}
