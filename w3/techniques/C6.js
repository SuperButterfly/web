export const data = {
    ...
    example: [
        {
            title: 'Ejemplo 1: ',
            resume:'En este ejemplo, se han aplicado marcas estructurales (listas de definición) al contenido. CSS se ha utilizado para diseñar el contenido en forma de columnas. Cada clase posiciona absolutamente el contenido en columnas y los márgenes se han establecido en 0 para anular el comportamiento predeterminado de los agentes de usuario para mostrar listas de definiciones HTML con el elemento DD sangrado.',
