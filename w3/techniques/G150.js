export const data = {
    ...
    example: [
        {
            title: 'Ejemplo 1:',
            resume:'Una estación de radio utiliza servicios de subtítulos basados ​​en la web para brindar alternativas para eventos deportivos en vivo; la salida del servicio se incorpora en una ventana de visualización de la página web que también incluye un control de transmisión de audio.'
        }
    ],
