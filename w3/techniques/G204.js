export const data = {
    ...
    resume: 'Esta técnica evita el desplazamiento horizontal de los bloques de texto cuando la ventana se estrecha. Esto se logra definiendo el ancho de los contenedores de texto en porcentajes. Esto permite que los agentes de usuario HTML y XHTML redistribuyan el texto automáticamente sin necesidad de especificar anchos en medidas absolutas.',
    
    example: [
        {
            title: 'Ejemplo 1:',
            resume:'Un sitio de periódico incluye artículos con columnas que se ajustan con el ancho de la ventana de los agentes de usuario. Los usuarios con discapacidades cognitivas pueden reducir la columna a un ancho que facilite la lectura.'
        }
    ],
