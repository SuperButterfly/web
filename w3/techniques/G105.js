export const data = {
  ...
  applicability:
    'Páginas web que requieren autenticación de usuario y limitan el tiempo disponible para el envío de datos.',
