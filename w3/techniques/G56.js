    ...
    example: [
        {
            ...
            resume:'Un narrador está describiendo una escena de disturbios. El volumen de la escena del motín se ajusta para que sea 20 db más bajo que el volumen del locutor antes de que la escena se mezcle con el narrador.'
        },
        {
            title: 'Ejemplo 2: contraste de audio suficiente entre un narrador y la música de fondo',
            resume:'Este ejemplo muestra una voz con música de fondo en la que la voz está 20 DB por encima del fondo. La voz (en primer plano) se graba a -17,52 decibelios (RMS promedio) y la música (de fondo) a -37,52 decibelios, lo que hace que el primer plano sea 20 decibelios más fuerte que el fondo. Ejemplo de sonido Ejemplo de audio: el primer plano está 20 decibelios por encima del fondo (mp3) Transcripción del ejemplo de audio (buen contraste): "Por lo general, el primer plano se refiere a una voz que habla y debe entenderse. Mi voz en este momento está 20 decibelios por encima del fondo, que es la música. Este es un ejemplo de cómo debe hacerse". Ejemplo visual de la grabación anterior El ejemplo de audio anterior se representa visualmente a continuación en una instantánea del archivo en un editor de audio. Se resalta una sección que contiene el primer plano y el fondo. Es una ola mucho más grande que la sección que contiene solo fondo.'
        }
    ],
