export const data = {
  ...
  example: [
    {
      title:
        'Ejemplo 1: aplicación Silverlight diseñada con recursos de pincel y recursos de plantilla que permiten un cambio de alto contraste',
      resume:
