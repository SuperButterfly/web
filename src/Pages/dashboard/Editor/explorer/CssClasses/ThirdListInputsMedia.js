...
export function ThirdListInputsMedia({
  ...
  const [showThirdListMedia, setShowThirdListMedia] = useState({second: false, third: false, fourth: false, fifth: false, indexMenu: 0})
  ...
  const showPropertiesList = ()=>{
       setShowThirdListMedia({second: !showThirdListMedia.second, third: false, fourth: false, fifth: false})
  }
  const showValueMediaList = ()=>{
       setShowThirdListMedia({second: false, third: !showThirdListMedia.third, fourth: false, fifth: false})
  }
  const showFourthListMedia = (index)=>{
        setShowThirdListMedia({second: false, third: false, fourth: !showThirdListMedia.fourth ,fifth: false, indexMenu: index})
  }
  const showFifthListMedia = (key, index)=>{
        setInputProperty(key); 
        //console.log("showFirstListMedia",showThirdListMedia)
        setShowThirdListMedia({second: false, third: false, fifth: !showThirdListMedia.fifth, fourth: false, indexMenu: index})
  }
...
const handleAddProperties = (index, item, listObject)=>{
   ...
   if(listObject.key != [indexesList]){
     ...
     setShowThirdListMedia((prev)=>({...prev, fourth: !showThirdListMedia.fourth}))
     //console.log("itemList", newObjProperty)
    }
    else{
         setShowThirdListMedia((prev)=>({...prev, fourth: false, fifth: !showThirdListMedia.fifth}))
     }
    }
  }
  ...
  const handleAddValue = (itemList)=>{
     if(itemList && inputProperty){
       const newPropertyAddList = { ...thirdPropertyMediaList, [inputProperty]: itemList }
                        ...
                        <div className="jsx-108338622">
                          <div className="pt-input-flexible">
                            <div className="input-addon-wrapper">
                              ...
                              ></input>
                          {showThirdListMedia.second && <div className="collapsable-container-second">
                        ...
                        <div className="jsx-108338622">
                          <div className="pt-input-flexible">
                            <div className="input-addon-wrapper">
                              ...
                              ></input>
                              {showThirdListMedia.third && <div className="collapsable-container-third">
