export const data = {
    ...
    applicability: 'Texto en color cuando el color se utiliza para transmitir información como palabras que son enlaces en un párrafo y elementos de una lista donde algunos son diferentes a otros y se presentan en texto de color',
    ...
    example: [
        {
            title: 'Ejemplo 1:',
            resume: 'El formato predeterminado para los enlaces en una página incluye presentarlos en un color diferente al resto del texto de la página y subrayarlos para que los enlaces sean identificables incluso sin visión de color.',
        },
        {
            title: 'Ejemplo 2:',
            resume: 'Un artículo que compara el uso de elementos similares en diferentes lenguajes de marcado utiliza texto en color para identificar los elementos de cada idioma. Los elementos del primer lenguaje de marcado se identifican con texto AZUL en negrita. Los elementos del segundo se presentan como ROJO, texto en cursiva.',
        },
        {
            title: 'Ejemplo 3:',
            resume: 'Un sitio de noticias enumera enlaces a sus artículos con información adicional como la sección, la hora de publicación y ubicación relacionada. Los enlaces tienen un color diferente al de la información adicional pero no están subrayados y se presentan en una fuente más grande para que los usuarios con discapacidades visuales los identifiquen con facilidad.',
        },
        {
            title: 'Ejemplo 4:',
            resume: 'Las noticias cortas a veces tienen oraciones que también son enlaces a más información. Esas oraciones están impresas en color y usan una fuente sans-serif mientras que el resto del párrafo está en Times-Roman negro.',
        },
    ],
