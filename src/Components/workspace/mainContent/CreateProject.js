                       ...
                       <div className="modal-create-header">
                         <div className="modal-create-container-button">
                           <button onClick={onClose} className="btn-create-back">
                              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="currentColor" d="M20 11H7.83l5.59-5.59L12 4l-8 8l8 8l1.41-1.41L7.83 13H20v-2z"/></svg>
                             &nbsp; Go Back
                           </button>
