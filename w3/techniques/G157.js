export const data = {
  ...
  applicability:
    'Todas las tecnologías que presentan información en vivo de solo audio.',
  ...
  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Una estación de radio por Internet proporciona una ventana gráfica en su página web para sus servicios de noticias. Los informes de noticias en vivo, especialmente los informes de emergencia, se transcriben mediante un servicio de subtítulos en tiempo real y se muestran en la ventana gráfica.'
    },
    {
      title: 'Ejemplo 2:',
      resume:
