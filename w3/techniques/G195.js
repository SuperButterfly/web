  ...
  example: [
    {
      ...
      resume:
        'Una página web tiene un color de fondo oscuro y texto y enlaces claros. Cuando el foco aterriza en un enlace, el enlace se destaca con una línea amarilla brillante, de 3 píxeles de ancho.'
    },
    {
      title: 'Ejemplo 2: elementos de formulario',
      resume:
        'Una página Web incluye un formulario dentro de una tabla. Los bordes tanto de la tabla como de los elementos del formulario son líneas negras finas. Cuando el foco aterriza en un elemento de formulario, el elemento se perfila con una línea roja de 5 píxeles que es parcialmente transparente. El rojo es equivalente a un color hexadecimal de #FF3838, lo que proporciona una relación de contraste de 3,6:1 con el fondo blanco.'
    },
    {
      title: 'Ejemplo 3: Menús',
      resume:
        'Una página web incluye un menú interactivo con submenús. Un usuario puede mover el foco en el menú usando las teclas de flecha. A medida que se mueve el enfoque, el elemento de menú actualmente enfocado cambia su fondo a un color diferente, que tiene una relación de contraste de 3:1 con los elementos circundantes y una relación de contraste de 4,5:1 con su propio texto.'
    }
  ],
