export const data = {
  ...
  applicability:
    'Todas las tecnologías con agente de usuario proporcionaron capacidad de zoom.',

  resume:
    'Esta técnica ofrece la capacidad de escalar contenido de forma uniforme en tecnologías web compatibles con agentes de usuario. Esto requiere que la función de zoom conserve todas las relaciones espaciales y que toda la funcionalidad siga siendo accesible. Para cumplir con este Criterio de Conformidad, debe realizarse pruebas con una amplia variedad de agentes de usuario.',

  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Internet Explorer 7 y Opera 9 proporcionan una función de zoom que escala el contenido de la página HTML/CSS de manera uniforme.'
    },
    {
      title: 'Ejemplo 2:',
      resume:
        'Para permitir a los usuarios cambiar el tamaño del texto, Adobe Reader proporciona una herramienta de ampliación que escala las páginas PDF de manera uniforme.'
    }
  ],
