export const data = {
   name: 'G82',
    ...
    resume: ' Esta técnica utiliza el elemento HTML5 de track para especificar una pista de texto cronometrada de descripciones para un elemento de video. Esto permite a los usuarios obtener información no visualmente del recurso multimedia. No hay soporte nativo para esto en los agentes de usuario, pero el soporte está disponible a través de polyfills de JavaScript.',
    
    example: [
        {
            title: 'Ejemplo 1: descripción de audio en un idioma',
            resume: 'Un videoelemento para un video en el idioma inglés. Las descripciones de audio se proporcionan en formato WebVTT. ',
        ...
        },
        {
            ...
            resume: 'Un videoelemento para un video con un elemento fuente en inglés y francés, y con una pista de descripción de audio en inglés y francés utilizando el formato de archivo WebVTT (vtt).',
        ...
        },
        {
          ...
          resume:'A video, "Coche autónomo de Google". con una pista de audio descripción.',
