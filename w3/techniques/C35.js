export const data = {
    ...
    resume: 'La técnica de resumen de texto se utiliza para permitir que los usuarios resuman el contenido de un documento para que sea más fácil de entender. Esto puede incluir el uso de herramientas de resumen como la extracción de frases clave, la eliminación de palabras vacías, la consolidación de contenido, la abreviación de palabras, entre otros. Esta técnica es útil para personas con discapacidades cognitivas o con baja visión que necesitan una forma más clara y concisa de leer el contenido.',
    
    example: [
        {
            title: 'Ejemplo 1: una caja de tamaño con espacio para permitir la expansión',
