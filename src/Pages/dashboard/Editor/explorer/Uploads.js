    ...
    <div className="uploads-container">
      {!images.length ? (
        <>
          ...
          <div className="foldersjsx-4233665541">
            {folders.map((folder, index) => (
              <div
                className="asset-folderjsx-1916164855"
                key={index}
                id="hover-folder"
              >
          ...
          <>
              ...
              {folders.map((folder, index) => (
                ...
                >
                  <div className="left-side">
                    ...
                    <span id="tooltip-text">{folder}</span>
                    <div className="text-left">{folder}</div>
                  </div>
            ...
            <div className="jsx-4233665541">
              ...
              <div className="button-container">
                ...
                >
                  <div className="pt-icon folder-move-to">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                ...
                <button
                  ...
                  className="pt-btn-transparent-neutral"
                >
                  <div className="pt-icon download">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
