export const data = {
    ...
    applicability: 'Todas las tecnologías que presentan una descripción de una representación de contenido para el usuario.',
    ...
    example: [
        {
            title: 'Ejemplo 1: ',
            resume: `Se proporciona un botón redondo en un formulario para enviar el formulario y pasar al siguiente paso en una progresión. El botón está etiquetado con el texto "ir". Las instrucciones dicen: "para enviar el formulario, presione el botón redondo con la etiqueta ir ". Esto incluye tanto la forma como la información textual para ubicar el botón.`
        },
        {
            title: 'Ejemplo 2: ',
            resume: `Las instrucciones para una página web que proporciona capacitación en línea indican: "Use la lista de enlaces a la derecha con el encabezado 'Lista de clases' para navegar al curso en línea deseado". Esta descripción proporciona la ubicación, así como pistas textuales para ayudar a encontrar la lista correcta de enlaces.`
        },
        {
            title: 'Ejemplo 3: ',
            resume: `El siguiente diseño coloca un botón en la esquina inferior derecha y lo indica por posición. Una indicación de la etiqueta de texto aclara qué botón usar para los usuarios que acceden a una versión lineal en la que la posición no es significativa.`,
