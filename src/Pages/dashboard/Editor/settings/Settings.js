...
const Settings = () => {
  ...
  return <div className="settings-container">
    ...
    <Paddings />
    { componentSelected?.tag==="a" || componentSelected?.tag==="span" || componentSelected?.tag==="h1" || componentSelected?.tag==="link" &&  <Text/>}
    { componentSelected?.tag !=="select" && componentSelected?.tag!=="iframe" && componentSelected?.tag!=="img" && componentSelected?.tag!=="video"? <Background/>:null}
