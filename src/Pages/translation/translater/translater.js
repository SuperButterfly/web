...
const Main = () => {
  ...
  return (
    <div  style={{width:"100%"}}>
    <div class="d-flex">
      <div class="search ml-2 mr-2">
        <div  class="d-flex">
          <div className="dropdown">
            <button onClick={handleOpen}>
            Filters<span class="badge">1</span></button>
            {open ? (
              <ul className="menu">
          ...
          <div class="search-input">
            ...
            <svg 
              xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search search-icon" viewBox="0 0 16 16"
            >
        ...
        <div class="home-settings home-translate">
        <ul class="ul-items">
        <li class="list-group-item">asfs</li>
         <li class="list-group-item">asfs</li>
         </ul>
        </div>
      </div>
        <div class="result ml-2 mr-2">
          <div class="d-flex">
            <form onSubmit={handleSubmit}>
              ...
              />
              <button class="ml-2" type="submit">Import</button>
            </form>
          </div>
          <textarea/>
          <textarea/>
