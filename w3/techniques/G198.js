export const data = {
  ...
  resume:
    ' El objetivo de esta técnica es proporcionar un mecanismo para que las personas que no pueden completar tareas dentro de un límite de tiempo específico desactiven el límite de tiempo.',

  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Una página tiene una lista de titulares de noticias que se actualizan automáticamente cada minuto. En la parte superior de la página hay un enlace que desactiva la actualización.'
    }
  ],
