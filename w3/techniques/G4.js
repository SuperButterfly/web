  ...
  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Un sitio contiene un banner de noticias que se desplaza en la parte superior de la página. Los usuarios que necesiten más tiempo para leerlo pueden presionar la tecla Escape para pausar el desplazamiento. Al presionar Escape nuevamente, se reinicia..'
    },
    {
      title: 'Ejemplo 2:',
      resume:
        'Una página web contiene un enlace denominado "Cómo atarse un zapato" que enlaza con una animación. El texto que precede inmediatamente al enlace informa al usuario que al presionar la barra espaciadora se pausará la animación y se reiniciará de nuevo.'
    }
  ],
