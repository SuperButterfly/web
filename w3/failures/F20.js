export const data = {
    ...
    resume: 'Esta condición de falla aborda situaciones en las que la alternativa de texto no es actualizada al mismo tiempo que el contenido que no es de texto, haciendo que el texto ya no sea una alternativa válida para el contenido que no es de texto.',
    ...
    example: [
        {
            ...
            resume: 'un gráfico de ventas se actualiza con los resultados de octubre, pero la alternativa de texto sigue describiendo los resultados de septiembre.'
        },
        {
            title: 'Ejemplo de error 2',
            resume: 'las imágenes en una página de inicio cambian a diario, pero las alternativas de texto no se actualizan al mismo tiempo.'
        },
        {
            title: 'Ejemplo de error 3',
            resume: 'el atributo de origen de las imágenes en una página se actualiza periódicamente mediante un script, pero las alternativas de texto no se actualizan al mismo tiempo'
        },
    ],
