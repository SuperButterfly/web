export const data = {
  ...
  example: [
    ...
    },
    {
      ...
      resume:
        'Este ejemplo muestra cómo definir cadenas como recursos y vincularlas a los campos de formulario tanto con Tooltip como con AutomationProperties.HelpText. No se realiza validación del lado del cliente, pero puede haber validación del lado del servidor. La siguiente es la interfaz de usuario XAML:',
