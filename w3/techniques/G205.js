  ...
  example: [
    {
      ...
      resume:
        'Las instrucciones para un formulario en línea dicen: "Los campos obligatorios se muestran en rojo y están marcados con (obligatorio)". La señal "(obligatorio)" se incluye dentro del elemento de etiqueta.',
