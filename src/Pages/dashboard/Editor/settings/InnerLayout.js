...
const InnerLayout = () => {
  ...
  useEffect(()=>{
    if(target.properties&&target.properties.style){
      setStateInnerLayout({
        justifyContent:target.properties.style.justifyContent? target.properties.style.justifyContent : '',
        flexDirection:target.properties.style.flexDirection? target.properties.style.flexDirection : '',
        alignItems:target.properties.style.alignItems? target.properties.style.alignItems : '',
        flexWrap:target.properties.style.flexWrap? target.properties.style.flexWrap : '',
  ...
  const handleDispachUpdateComponent = (section,value) =>{
    ...
    dispatch(updateComponent(target.id,{
      ...target,
      properties:{
        ...target.properties,
        style:{
    ...
    <div className="inner-layout-container">
        <div className="inner-layout-component-header">
          ...
          <div className="inner-layout-container2">
            <input 
              ...
              title="row" 
              name="row"
              className={stateInnerLayout.flexDirection==="row"?"inner-layout-icon-click":"inner-layout-icon"} 
            ...
            <input 
              ...
              name="column"
              value="🡓"
              className={stateInnerLayout.flexDirection==="column"?"inner-layout-icon-click":"inner-layout-icon"} 
        ...
        </div>
        {
          ...
          <div>
            <div className="inner-layout-container4">
              <svg 
                className={stateInnerLayout.justifyContent==="flex-start"?"inner-layout-selected":"inner-layout-icon06"} 
              ...
              <svg 
                className={stateInnerLayout.justifyContent==="center"?"inner-layout-selected":"inner-layout-icon06"} 
              ...
              <svg 
                className={stateInnerLayout.justifyContent==="flex-end"?"inner-layout-selected":"inner-layout-icon06"}  
              ...
              <svg 
                className={stateInnerLayout.justifyContent==="space-between"?"inner-layout-selected":"inner-layout-icon06"}   
              ...
              >
                ...
                <path fill-opacity="0.4" d="M11.133 2.116v3h-7v-3zM11.132 12.117v3h-7v-3h7z"></path>
              </svg>
            </div>
            <div className="inner-layout-container3">
              <svg 
                className={stateInnerLayout.alignItems==="flex-start"?"inner-layout-selected":"inner-layout-icon04"}  
              ...
              <svg 
                className={stateInnerLayout.alignItems==="center"?"inner-layout-selected":"inner-layout-icon04"}   
              ...
              <svg 
                className={stateInnerLayout.alignItems==="flex-end"?"inner-layout-selected":"inner-layout-icon04"}   
              ...
              >
                ...
                <path fill-opacity="0.4" d="M0 3h11v3H0zM4 9h7v3H4z"></path>
              </svg>
              <svg 
                className={stateInnerLayout.alignItems==="stretch"?"inner-layout-selected":"inner-layout-icon04"}  
              ...
              >
                <title>stretch</title>
                <path d="M17 0v15h-1V0h1zM1 0v15H0V0h1z" fill-opacity="0.4"></path>
                <path d="M14 3v3H3V3h11zM14 9v3H3V9z" fill-opacity="0.4"></path>
              </svg>
            </div>
          </div>
        :
          <div>
            ...
            <div className="inner-layout-container4">
              <svg 
                className={stateInnerLayout.alignItems==="flex-start"?"inner-layout-selected":"inner-layout-icon06"}   
                onClick={()=>handleClickSvg("alignItems","flex-start")} 
                width="15" 
                height="15" 
                viewBox="0 0 15 15" 
              ...
              <svg 
                className={stateInnerLayout.alignItems==="center"?"inner-layout-selected":"inner-layout-icon06"}  
                onClick={()=>handleClickSvg("alignItems","center")}
                width="15" 
                height="15" 
                viewBox="0 0 15 15" 
              ...
              <svg 
                className={stateInnerLayout.alignItems==="flex-end"?"inner-layout-selected":"inner-layout-icon06"}
                onClick={()=>handleClickSvg("alignItems","flex-end")}  
                width="15" 
                height="15" 
                viewBox="0 0 15 15" 
              ...
              <svg 
                className={stateInnerLayout.alignItems==="stretch"?"inner-layout-selected":"inner-layout-icon06"}
                onClick={()=>handleClickSvg("alignItems","stretch")}  
                width="15" 
                height="17" 
                viewBox="0 0 15 17" 
        ...
        <div className="inner-layout-container5">
          <div className="inner-layout-container6">
            <span>Gap</span>
            <input name="gap" onBlur={ handleInputChange } defaultValue={stateInnerLayout.gap} className="inner-layout-input" placeholder="0"/>
          </div>
          <div className="inner-layout-container7">
            <input type="checkbox" checked={stateInnerLayout.flexWrap==="wrap"} name="flexWrap" onChange={handleWrapChange}/>
            <span>Wrap</span>
          </div>
        </div>
    </div>
