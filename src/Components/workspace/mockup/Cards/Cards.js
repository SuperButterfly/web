  ...
  return (
    <>
            <div className="plantilla1 template-card">
              ...
              >
                <div
                  className={display.plantilla1 ? 'card-overlay' : 'display'}
                >
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla2 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
                        Quick Preview
                      </button>
                    </div>
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla3 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla4 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla5 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla6 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla7 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla8 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla9 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla10 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla11 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
            ...
            <div className="template-card">
              ...
              >
                <div
                  className={display.plantilla12 ? 'card-overlay' : 'display'}
                >
                  <div className="pt-stack-card">
                    <div className="btn-wrapper">
                      <button className="btn-overlay preview">
