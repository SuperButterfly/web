...
const Paddings = () => {
  ...
  useEffect(()=>{
    let actPadding = initialPaddingProperties;
    let media="px";
    let auxPadding = {}
  ...
  const handlePadding = ev =>{
    ...
    if(ev.target.value.length>0){
      ...
      paddingMedias.forEach(med=>{
        if(med!==ev.target.name && input[med])
          actPadding[med]=input[med]
      })
  ...
  const handleSelect = ev =>{
    ...
    paddingMedias.forEach(med=>{
      if(input[med])
        actPadding[med]=`${input[med]}${ev.target.value}`
    })
    setInput({...input, [ev.target.name]:ev.target.value})
    dispatch(updateComponent(componentSelected.id,{
      properties:{ 
  ...
  return (
    <div className="paddings-container">
        ...
        <div className="paddings-container2" style={isOpen ? { display: 'flex'} : { display: 'none' }}>
          <input className="paddings-text" name='paddingTop' value={input.paddingTop} onChange={handleInputChange} onBlur={handlePadding} autoComplete="off"/>
          <svg className="paddings-container3" width="1" height="12" viewBox="0 0 1 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 .5a.5.5 0 011 0v11a.5.5 0 01-1 0V.5z"></path></svg>
          <div className="paddings-container4">
            <input className="paddings-text" name='paddingLeft' value={input.paddingLeft} onChange={handleInputChange} onBlur={handlePadding} autoComplete="off"/>
            <svg className="paddings-container5" width="16" height="2" viewBox="0 0 16 2" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.25.5a.75.75 0 010 1.5h-2.5a.75.75 0 010-1.5h2.5zM15.25.5a.75.75 0 010 1.5h-2.5a.75.75 0 010-1.5h2.5zM3.25.5a.75.75 0 010 1.5H.75a.75.75 0 010-1.5h2.5z"></path></svg>
            <svg
            ...
            <svg className="paddings-container6" width="16" height="2" viewBox="0 0 16 2" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.25.5a.75.75 0 010 1.5h-2.5a.75.75 0 010-1.5h2.5zM15.25.5a.75.75 0 010 1.5h-2.5a.75.75 0 010-1.5h2.5zM3.25.5a.75.75 0 010 1.5H.75a.75.75 0 010-1.5h2.5z"></path></svg>
            <input className="paddings-text" name='paddingRight' value={input.paddingRight} onChange={handleInputChange} onBlur={handlePadding} autoComplete="off"/>
          </div>
          <svg className="paddings-container7" width="1" height="12" viewBox="0 0 1 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 .5a.5.5 0 011 0v11a.5.5 0 01-1 0V.5z"></path></svg>
          <input className="paddings-text" name='paddingBottom' value={input.paddingBottom} onChange={handleInputChange} onBlur={handlePadding} autoComplete="off"/>
        <div className="paddings-medias-container">
          <span className="paddings-text1" htmlFor="selectUnitLength">Unit of length</span>       
