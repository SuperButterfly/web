...
import { updateWorkspace } from '../../../../src/redux/actions/workspaces'
// TODO: sacar esta constante a otro archivo
const paises = [
  {
    nombre: 'Afganistán',
    image: ' https://www.banderas-mundo.es/data/flags/h80/af.webp'
  },
  {
    nombre: 'Albania',
    image: ' https://www.banderas-mundo.es/data/flags/h80/af.webp'
...
const BillingDetails = () => {
  ...
  const methods = ['PayPal', 'Credit Card', 'Bank Transfer']
  ...
  const handleSubmitChanges = async (e) => {
    ...
    try {
      ...
      await dispatch(
        updateWorkspace(workspaceSelected.id, {
          billingdetails: billingProperties
        })
      )
      setBillingProperties({
        account: '',
        name: '',
        address: '',
        country: '',
  ...
  return (
    <div className="temp-container">
      <div className="container01 temp-container01">
        <div className="container02 temp-container02">
          <input
            ...
            id="individual"
          />
          <label className="text temp-text" htmlFor="individual">
            Individual
          </label>
        </div>
        <div className="container03 temp-container03">
          <input
            ...
            id="company"
          />
          <label className="text1 temp-text1" htmlFor="company">
            Company
          </label>
        </div>
      </div>
      <div className="container04 temp-container04">
        ...
        <span className="text3 temp-text3">
          The name that will be used for your invoice
        </span>
      ...
      <div className="container06 temp-container06">
        ...
        <span className="text5 temp-text5">
          Billing address that will be used for your invoice
        </span>
      ...
      <div className="container08 temp-container08">
        ...
        <div className="container09 temp-container09">
          <select
            value={billingProperties.method}
          ...
          >
            ...
            {methods.map((e, index) => (
              <option
                key={index}
                value={handleSelectMethodChange}
                className="temp-container05 pt-inline2"
              >
                {e}
              </option>
            ))}
      ...
      <div className="container08 temp-container08">
        ...
        <span className="text7 temp-text7">
          Country that will be used for your invoice
        </span>
        <div className="container09 temp-container09">
          <select
            value={billingProperties.country}
