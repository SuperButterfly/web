...
const DOM_URL = `https://api.scaleway.com/domain/v2beta1/search-domains?domains=`;
...
module.exports = {
  SCW_SECRET_KEY, SCW_DEFAULT_ZONE, SCW_PROJECT_ID, API_URL, DOM_URL, VOLUME_URL, HEADERS
}