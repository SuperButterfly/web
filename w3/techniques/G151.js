  ...
  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Una obra de radio en vivo de un grupo de teatro marginal se está transmitiendo a la Web. Como los actores se apegan en gran medida a un guión establecido y el presupuesto del programa es pequeño, los productores proporcionan un enlace (con el permiso del dramaturgo) al guión de la obra en HTML.'
    },
    {
      title: 'Ejemplo 2:',
      resume:
        'Un miembro del gobierno transmite un importante discurso político en la Web. Una transcripción del discurso está disponible en el sitio web cuando comienza el discurso.'
    }
  ],
