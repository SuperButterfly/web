  ...
  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Una página con algunos titulares que no cumplen los requisitos de contraste de 3:1 tiene un enlace de contraste alto (5:1) en la parte superior de la página que lleva al usuario a una nueva versión de la página con un contraste mínimo de 4,5:1 en todos texto e imágenes de texto.'
    },
    {
      title: 'Ejemplo 2:',
      resume:
        'Una página utiliza fondos sombreados para el efecto, pero da como resultado un contraste de texto a fondo de 4:1. Un control en la parte superior de la página dice "alto contraste". Al hacer clic en él, se usan diferentes estilos y se sueltan los colores de fondo para lograr un contraste de 7:1.'
    }
  ],
