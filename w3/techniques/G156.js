export const data = {
  ...
  resume:
    'El autor web diseña la página para que funcione con navegadores que tengan controles de cambio de colores, y no los anula. Esto permite que las personas con discapacidades cognitivas comprendan correctamente el contenido de la página web. Si se usan colores de fondo para delinear áreas de la página, se puede especificar colores de texto y de fondo del contenido secundario sin especificar los colores del contenido principal para permitir que el usuario controle los colores.',

  example: [
    {
      title: 'Ejemplo 1:',
      resume:
        'Una página web se diseña utilizando HTML y CSS para especificar los colores de primer plano y de fondo. El usuario establece sus propios colores en Internet Explorer 7 y puede ver el contenido con los colores de fondo y de primer plano elegidos.'
    },
    {
      title: 'Ejemplo 2:',
      resume:
        'Una página web se diseña utilizando HTML y CSS. Hay un enlace en la página a instrucciones sobre cómo configurar colores en varios navegadores.'
    }
  ],
