...
export default function MyApp({
  ...
  const pagesDocumentPath = '_document'
...
module.exports = {
  ...
  zip.file('vue.config', vueConfigContent)
...
module.exports = {
  ...
  zip.file('babel.config', babelConfigContent)
...
.home-container {
  ...
  srcFolder.file('main', mainContent)
  srcFolder.file('router', routerContent)
  srcFolder.file('style', styleContent)
...
Vue.use(LottieVuePlayer);`
  ...
  zip.file('nuxt.config', nuxtConfigContent)
  zip.file('package.json', packageJsonContent)
  ...
  pluginsFolder.file('lottie-vue-player.client', pluginsLottieContent)
...
const generateZipReactNative = async (fileContent, componentName, language) => {
  ...
  zip.file('React-Native-Component', componenteTraducido)
