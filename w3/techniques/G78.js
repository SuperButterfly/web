export const data = {
    ...
    applicability: 'Se aplica a cualquier tecnología que tenga banda sonora y contenido visual.',
    ...
    example: [
        {
            title: 'Ejemplo 1:',
            resume: 'Un diario de viaje del noreste tiene una descripción de audio adicional agregada durante los espacios en el diálogo para que los oyentes ciegos sepan de qué está hablando la persona en cualquier momento.'
        },
        {
            title: 'Ejemplo 2:',
            resume: 'Un video muestra a un pájaro carpintero tallando un nido en un árbol. Un botón dentro del contenido permite a los usuarios activar o desactivar la pista de descripción de audio.'
        },
        {
            title: 'Ejemplo 3:',
            resume: 'A una clase se le agrega una descripción de audio cada vez que el instructor dice cosas como "y esta es la más importante". Las descripciones de audio les permiten a los oyentes que no pueden ver el video saber qué es "esto".'
        },
        {
            title: 'Ejemplo 4',
            resume:'Un archivo de película tiene dos pistas de audio, una de las cuales incluye una descripción de audio. Los usuarios pueden elegir cualquiera de los dos cuando escuchan la película seleccionando la pista adecuada en su reproductor multimedia.',
        },
    ],
