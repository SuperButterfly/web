export const data = {
    ...
    applicability: 'Se aplica siempre que el reproductor SMIL 2.0 esté disponible',
    ...
    example: [
        {
            title: 'Ejemplo 1: muestra de descripción de audio SMIL 2.0 para reproductor RealMedia',
            resume:'El ejemplo muestra un segmento <par> que contiene una etiqueta <audio> y <video>. La transmisión de audio no se inicia inmediatamente.',
