    ...
    return (
        ...
        <div className={`${styles.rectangulo} ${expandedRectangulos['rectangulo1'] ? styles.expandedRectangulo : ''}`}>
                <div className={styles.contenedor}>
                    ...
                    <h5 className={styles.tituloFront}><span className={styles.instant}>INSTANT</span> Generic Creation Workspace</h5>
                    <div className={`${styles.contenedorOpciones} ${styles.opciones}`}>
                        ...
                        <svg className={styles.iconDownArrow} onClick={() => toggleExpand('rectangulo1')}></svg>
            ...
            <div className={`${styles.rectangulo} ${expandedRectangulos['rectangulo2'] ? styles.expandedRectangulo : ''}`}>
                <div className={styles.contenedor}>
                    <div className={styles.contenedorOpciones}>
                    ...
                    <div className={`${styles.contenedorOpciones} ${styles.opciones}`}>
                        ...
                        <svg className={styles.iconDownArrow} onClick={() => toggleExpand('rectangulo2')}></svg>
            ...
            <div className={`${styles.rectangulo} ${expandedRectangulos['rectangulo3'] ? styles.expandedRectangulo : ''}`}>
                <div className={styles.contenedor}>
                    <div className={styles.contenedorOpciones}>
                    ...
                    <div className={`${styles.contenedorOpciones} ${styles.opciones}`}>
                        ...
                        <svg className={styles.iconDownArrow} onClick={() => toggleExpand('rectangulo3')}></svg>
            ...
            <div className={`${styles.rectangulo} ${expandedRectangulos['rectangulo4'] ? styles.expandedRectangulo : ''}`}>
                <div className={styles.contenedor}>
                    <div className={styles.contenedorOpciones}>
                        <svg className={styles.iconTrello}></svg>
                        <svg className={styles.iconRightArrow}></svg>
                    ...
                    <div className={`${styles.contenedorOpciones} ${styles.opciones}`}>
                        ...
                        <svg className={styles.iconDownArrow} onClick={() => toggleExpand('rectangulo4')}></svg>
            ...
            <div className={`${styles.rectangulo} ${expandedRectangulos['rectangulo5'] ? styles.expandedRectangulo : ''}`}>
                <div className={styles.contenedor}>
                    ...
                    <h5 className={styles.tituloFront}><span className={styles.instant}>INSTANT</span> Generic Trigger</h5>
                    <div className={`${styles.contenedorOpciones} ${styles.opciones}`}>
                        <button>
                            <label className={styles.switch} >
                            <input type="checkbox"></input>
                        ...
                        <svg className={styles.iconDownArrow} onClick={() => toggleExpand('rectangulo5')}></svg>
            ...
            <div className={`${styles.rectangulo} ${expandedRectangulos['rectangulo6'] ? styles.expandedRectangulo : ''}`}>
                <div className={styles.contenedor}>
                    <div className={styles.contenedorOpciones}>
                        <svg className={styles.iconSlack}></svg>
                        <svg className={styles.iconRightArrow}></svg>
                    ...
                    <h5 className={styles.tituloFront}><span className={styles.instant}>INSTANT</span> Slack2nuxeo</h5>
                    <div className={`${styles.contenedorOpciones} ${styles.opciones}`}>
                        <button>
                            <label className={styles.switch} >
                            <input type="checkbox"></input>
                        ...
                        <svg className={styles.iconDownArrow} onClick={() => toggleExpand('rectangulo6')}></svg>
