export const data = {
    ...
    resume: 'La intención de esta técnica es permitir que un usuario controle el uso de sonidos en el contenido web. A alguien que usa un lector de pantalla le puede resultar muy molesto y difícil escuchar su lector de pantalla si también hay sonidos provenientes del contenido web. Proporcionar una forma de reproducir sonidos solo a pedido le dará al usuario el control necesario para escuchar cualquier sonido u otro audio sin interferir con la salida de un lector de pantalla.',
    
    example: [
        {
            title: 'Ejemplo 1',
            resume: 'Una página web de una sociedad de conservación de ballenas grises tiene un sonido de fondo continuo del canto de las ballenas grises. También hay sonidos de salpicaduras de agua. Los sonidos no se inician automáticamente. En su lugar, el contenido web proporciona un enlace en la parte superior de la página para permitir que el usuario inicie los sonidos manualmente. El botón dice "Activar sonidos". Después de presionar el botón "activar sonidos", se escuchan los sonidos. Luego, al usuario se le presenta una opción para "desactivar los sonidos".'
        },
        {
            title: 'Ejemplo 2:',
            resume: 'Se proporciona un enlace a un archivo de sonido que incluye los sonidos de las ballenas grises. El texto del enlace dice: "Escucha el canto de la ballena gris (mp3)".'
        }
    ],
