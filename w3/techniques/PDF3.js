      ...
      procedure: [
        {
          ...
          suborder: [
            'Lea el documento PDF con un lector de pantalla o una herramienta que lea en voz alta, escuchando para escuchar que cada elemento se lee en el orden correcto.',
            'Utilice una herramienta que exponga el documento a través de la API de accesibilidad y verifique que el orden de lectura sea el correcto.'
          ]
        },
        {
          order: 2,
          ...
          suborder: [
            'Use la tecla de tabulación para recorrer el orden de enfoque en el documento.',
            'Utilice una herramienta que sea capaz de mostrar la entrada del objeto de página que especifica la configuración del orden de tabulación para abrir el documento PDF y ver la configuración.'
          ]
        }
      ],
