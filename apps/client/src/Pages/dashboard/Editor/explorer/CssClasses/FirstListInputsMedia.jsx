...
export function FirstListInputsMedia({
  ...
  const [showFirstListMedia, setShowFirstListMedia] = useState({
    second: false,
    third: false,
    fourth: false,
    fifth: false,
  ...
  const showPropertiesList = () => {
    setShowFirstListMedia({
      second: !showFirstListMedia.second,
      third: false,
      fourth: false,
      fifth: false
    })
  ...
  const showValueMediaList = () => {
    setShowFirstListMedia({
      second: false,
      third: !showFirstListMedia.third,
      fourth: false,
      fifth: false
    })
  }
  const showFourthListMedia = (index) => {
    setShowFirstListMedia({
      second: false,
      third: false,
      fourth: !showFirstListMedia.fourth,
      fifth: false,
      indexMenu: index
    })
  }
  const showFifthListMedia = (key, index) => {
    ...
    setShowFirstListMedia({
      second: false,
      third: false,
      fifth: !showFirstListMedia.fifth,
      fourth: false,
      indexMenu: index
    })
  }
