  ...
  return (
    <div className="main-header-container">
      <div className="main-header-logo-container">
        ...
        {
          isModalOn1 && 
          <TeleModal teledata={teledata} handleChangeModal1={handleChangeModal1} handleModal1={handleModal1}/>
        }
        {
          isModalOn2 &&
          <TeleProgress handleModal2={handleModal2} progress={progress} />
        }
        <svg viewBox="0 0 1024 1024" className="main-header-menu-icon" onClick={() => closeMenu1(true)}>
          <path d="M128 256h768v86h-768v-86zM128 554v-84h768v84h-768zM128 768v-86h768v86h-768z"></path>
        </svg>
      </div>
      
      <span className="main-name-project">{
        projectSelected && projectSelected !== {} ? projectSelected.name : 'Name Project'
      } editor</span>
      <div className="main-header-container1">
        ...
        <button className="main-header-share" onClick={()=>closeShare(true)}>Share</button>
        ...
        <svg viewBox="0 0 1097.142857142857 1024" className="main-header-icon" onClick={() => handleShow()}>
