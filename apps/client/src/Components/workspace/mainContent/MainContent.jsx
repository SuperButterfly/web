...
import { removeNotification } from '@/redux/actions/user'
// import dayjs from "dayjs";
import './mainContent.css'
import { selectProject } from '@/redux/slices/projectSlices'
import { getTarget, createProject } from '@/redux/actions/projects'
import { shareWorkspace } from '@/redux/actions/workspaces'
import MeetAdd from '../modal/MeetAdd'
import ModalPortal from '../modal/Modal'
import AcceptInvitation from '../invitationEmail/AcceptInvitation'
...
const MainContent = () => {
  ...
  useEffect(() => {
    if (user.notifications?.length > 0 && user.notifications.length !== 0) {
