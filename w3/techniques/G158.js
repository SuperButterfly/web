export const data = {
    ...
    resume: 'Esta técnica implica la creación de un documento que cuente la misma historia que el contenido pregrabado de audio, para proporcionar una forma alternativa accesible de presentar la información. El documento contendría todos los diálogos y otros detalles importantes de la presentación de audio, y se crearía a partir del guión original o de la versión editada final.',
    
    example: [
        {
          title: 'Ejemplo',
          resume: 'Un podcast incluye una descripción de las nuevas funciones en una versión de software reciente. Se trata de dos oradores que discuten informalmente las funciones nuevas y actualizadas y describen cómo se utilizan. Uno de los oradores trabaja a partir de una lista de preguntas que se utilizó para delinear la discusión antes de la grabación. Una vez completada la grabación, el esquema se edita y complementa para que coincida con el diálogo, etc. La transcripción resultante se pone a disposición en el sitio web de los oradores junto con el archivo de solo audio. La alternativa de texto que identifica el contenido de solo audio dice: "Episodio 42: Versión 12 de Zap (sigue la transcripción del texto)" ',
        },
    ],
